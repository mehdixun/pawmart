    ...
    <div className="min-h-screen flex items-center justify-center bg-indigo-50 dark:bg-gray-900 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-xl rounded-xl p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              disabled={loading}
              className={`input input-bordered bg-gray-200 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 ${errors.email ? "border-red-500" : ""}`}
              {...register("email", { 
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              disabled={loading}
              className={`input bg-gray-200 input-bordered w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 ${errors.password ? "border-red-500" : ""}`}
          ...
          <button
            type="submit"
            disabled={loading}
            className={`btn btn-sm btn-outline font-bold text-lg btn-primary w-full ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
          >
        ...
        >
          ...
          {loading ? <span className="animate-pulse">Processing...</span> : "Login with Google"}
        </button>
